<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->dropDownListControlGroup($model, 'well_type_id', WellType::model()->getOptions(), array('empty' =>$model->getAttributeLabel('well_type_id'), 'class'=>'span5', 'maxlength'=>11)); ?>

	<?php echo $form->dropDownListControlGroup($model, 'country_id', Country::model()->getOptions(), array('empty' =>$model->getAttributeLabel('country_id'), 'class'=>'span5', 'maxlength'=>11, 'onChange' =>"updateCitiesDropDown( this.value, 'Well_city_id','".$model->getAttributeLabel('city')."')")); ?>
