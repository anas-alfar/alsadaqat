...
$this->menu=array(
	...
	array('label'=>Yii::t('OrganizationBranchCountry', 'Delete Organization Branch Country'),'url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
