<div class="view">
	...
	<?php echo CHtml::encode($data->beneficiaryRelationNameFilter($data)); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('educational_status')); ?>:</b>
	<?php echo CHtml::encode($data->educational_status); ?>
	<br />

	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('health_status')); ?>:</b>
	<?php echo CHtml::encode($data->health_status); ?>
	<br />
