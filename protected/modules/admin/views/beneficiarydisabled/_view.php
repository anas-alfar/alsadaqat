<div class="view">
	...
	<?php echo CHtml::encode($data->father_full_name); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('disability_type')); ?>:</b>
	<?php echo CHtml::encode($data->disability_type); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('disability_reason')); ?>:</b>
	<?php echo CHtml::encode($data->disability_reason); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('disability_description')); ?>:</b>
	<?php echo CHtml::encode($data->disability_description); ?>
	<br />
