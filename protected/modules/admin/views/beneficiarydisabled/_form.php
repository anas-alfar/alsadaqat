<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->dropDownListControlGroup($model, 'disability_type', ENUMHtml::enumItem($model, 'disability_type'), array('class'=>'span5', 'maxlength'=>8)); ?>

	<?php echo $form->dropDownListControlGroup($model, 'disability_reason', ENUMHtml::enumItem($model, 'disability_reason'), array('class'=>'span5', 'maxlength'=>17)); ?>

	<?php echo $form->textFieldControlGroup($model,'disability_description',array('class'=>'span5','maxlength'=>255)); ?>
