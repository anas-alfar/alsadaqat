<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->dropDownListRow($model, 'mail_type_id', MailType::model()->getOptions(), array('empty' =>$model->getAttributeLabel('mail_type_id'), 'class'=>'span5', 'maxlength'=>11)); ?>
	...
	<?php echo $form->textFieldRow($model,'from_mail',array('class'=>'span5','maxlength'=>255)); ?>
	...
	<?php echo $form->textFieldRow($model,'to_mail',array('class'=>'span5','maxlength'=>255)); ?>
	...
	<?php echo $form->textFieldRow($model,'send_at',array('class'=>'span5')); ?>
