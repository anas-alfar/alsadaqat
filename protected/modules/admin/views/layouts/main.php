  ...
  <head>
    ...
    <?php  
      ...
      <!-- styles for style switcher -->
        ...
        <link rel="alternate stylesheet" type="text/css" media="screen" title="style5" href="<?php echo $baseUrl;?>/css/<?php echo $this->currentLanguage ?>/style-orange.css" />
        <link rel="alternate stylesheet" type="text/css" media="screen" title="style6" href="<?php echo $baseUrl;?>/css/<?php echo $this->currentLanguage ?>/style-purple.css" />
        <link rel="alternate stylesheet" type="text/css" media="screen" title="style7" href="<?php echo $baseUrl;?>/css/<?php echo $this->currentLanguage ?>/style-red.css" />
      <?php
