...
$this->menu=array(
	...
	array('label'=>Yii::t('OrganizationUserAccessLevel', 'Delete User Access Level'),'url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?', 'csrf'=>true)),
