...
class ImageAttachmentWidget extends CWidget
{
    ...
    public function run()
    {
        ...
        $options = array(
        	'gender'	=> $this->model->gender_id,
            'hasImage' => $this->behavior->hasImage(),
            //'previewUrl' => $this->behavior->getUrl('preview'),
            'previewUrl' => Controller::getImageByCase('candidate_avatar', $this->model->id, $this->model->gender_id, '', '', 'large', $this->model->getheighestDegree()->category_id, $this->model->isSaudi()),
