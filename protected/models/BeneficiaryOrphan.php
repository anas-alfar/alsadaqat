...
/**
 * This is the model class for table "alsadaqat.beneficiary_orphan".
 *
 * The followings are the available columns in table 'alsadaqat.beneficiary_orphan':
 * @property string $id
 * @property string $father_full_name
 * @property integer $is_father_alive
 ...
 * @property integer $is_mother_alive
...
class BeneficiaryOrphan extends CActiveRecord
{
	...
	{
		return 'alsadaqat.beneficiary_orphan';
	}
	...
	public function rules()
	{
		...
		return array(
			array('father_full_name, is_father_alive, father_job, mother_full_name, is_mother_alive, mother_job, number_of_brothers, number_of_sisters, beneficiary_id, owner_id, created_at, updated_at, notes, options', 'required'),
			array('is_father_alive, is_mother_alive, number_of_brothers, number_of_sisters', 'numerical', 'integerOnly'=>true),
			...
			array('id, father_full_name, is_father_alive, father_job, father_date_of_birth, father_date_of_death, father_reason_of_death, father_death_certificate_path, mother_full_name, is_mother_alive, mother_job, mother_date_of_birth, mother_date_of_death, mother_reason_of_death, mother_death_certificate_path, number_of_brothers, number_of_sisters, beneficiary_id, owner_id, created_at, updated_at, notes, options', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('is_father_alive',$this->is_father_alive);
		...
		$criteria->compare('is_mother_alive',$this->is_mother_alive);
