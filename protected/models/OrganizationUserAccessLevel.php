...
/**
 * This is the model class for table "alsadaqat.organization_user_access_level".
 *
 * The followings are the available columns in table 'alsadaqat.organization_user_access_level':
 * @property string $id
...
class OrganizationUserAccessLevel extends CActiveRecord
{
	...
	{
		return 'alsadaqat.organization_user_access_level';
	}
	...
	public function rules()
	{
		...
		return array(
			array('user_id, organization_access_level_id, created_at, updated_at, notes, options', 'required'),
			array('user_id, organization_access_level_id', 'length', 'max'=>11),
			array('notes, options', 'length', 'max'=>1024),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, organization_access_level_id, created_at, updated_at, notes, options', 'safe', 'on'=>'search'),
		);
	}
