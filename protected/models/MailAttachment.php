...
class MailAttachment extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('mail_id, extension, size, source_path, source_url, owner_id, created_at, updated_at, notes, options', 'required'),
			...
			array('id, mail_id, name, extension, size, source_path, source_url, owner_id, created_at, updated_at, notes, options', 'safe', 'on'=>'search'),
		);
	}
