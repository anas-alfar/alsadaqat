...
class MosqueAgent extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('company_name, fullname, ssn, email, home_phone, work_phone, mobile, address, bank_name, bank_branch_name, bank_branch_number, bank_swift_code, bank_account_number, personal_photo_path, country_id, city_id, organization_id, owner_id', 'required'),
