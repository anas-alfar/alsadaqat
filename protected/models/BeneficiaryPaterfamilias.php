...
class BeneficiaryPaterfamilias extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('paterfamilias_first_name, paterfamilias_middle_name, paterfamilias_grandfather_name, paterfamilias_family_name, paterfamilias_date_of_birth, ssn, beneficiary_relation_id, beneficiary_id, owner_id, created_at, updated_at', 'required'),
