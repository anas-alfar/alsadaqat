 ...
 */
class OrganizationBranchCountryCommitteeUser extends Aulaula
{
	/**
	...
	public function search()
	{
		...
		$criteria->compare('organization_branch_country_committee_id',$this->organization_branch_country_committee_id,true);
	 ...
	 * @return OrganizationBranchCountryCommitteeUser the static model class
	 */
