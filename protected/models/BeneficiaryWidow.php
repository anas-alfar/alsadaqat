...
class BeneficiaryWidow extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('husband_full_name, husband_job, number_of_sons, number_of_daughters, beneficiary_id, owner_id, created_at, updated_at, notes, options', 'required'),
			...
			array('id, husband_full_name, husband_job, husband_date_of_birth, husband_date_of_death, husband_reason_of_death, husband_death_certificate_path, number_of_sons, number_of_daughters, beneficiary_id, owner_id, created_at, updated_at, notes, options', 'safe', 'on'=>'search'),
		);
	}
