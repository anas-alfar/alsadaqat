...
class EventPhoto extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('event_id, extension, width, height, size, source_path, source_url, owner_id, created_at, updated_at, notes, options', 'required'),
			array('event_id, width, height, size, owner_id', 'length', 'max'=>11),
			...
			array('id, event_id, title, extension, width, height, size, source_path, source_url, owner_id, created_at, updated_at, notes, options', 'safe', 'on'=>'search'),
		);
	}
