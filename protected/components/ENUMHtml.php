...
class ENUMHtml extends CHtml
{
    ...
    public static function enumActiveCheckboxList($model, $attribute, $htmlOptions=array())
    {
      return CHtml::activeCheckboxList( $model, $attribute, self::enumItem($model,  $attribute), $htmlOptions);
    }
